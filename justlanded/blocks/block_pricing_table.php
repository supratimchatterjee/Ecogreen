        ...
        <div class="pricing_table">
            ...
            if (isset($packages) && is_array($packages)) {
                ...
                foreach ($packages as $package) {
                    ...
                    if ($col_count == 4) $clear = ' last'; else $clear = '';
                    ?>

                    <!--Beginn Pricing Block-->
                    <div class="pricing_block<?php if (@$package['highlighted'] == "yes") echo ' highlighted'; ?> block block-row-<?php echo $row_count; ?> <?php echo $clear; ?>">
